...
dwv.gui.base.initDrawHtml = function()
{
    ...
    colourSelector.selectedIndex = 1;
...
/**
 * Append the color chooser HTML to the page.
 * @method appendManualmarkingHtml
 * @static
 */
dwv.gui.base.appendManualmarkingHtml = function()
{
    // colour select
    var colourSelector = dwv.html.createHtmlSelect("lwColourSelect",dwv.tool.colors);
    colourSelector.onchange = dwv.gui.onChangeLineColour;
...
/**
 * Display the manualmarking HTML.
 * @method displayManualmarkingHtml
 * @static
 * @param {Boolean} bool True to display, false to hide.
 */
dwv.gui.base.displayManualmarkingHtml = function(bool)
{
    // colour list
    dwv.html.displayElement("lwColourLi", bool);
};
...
/**
 * Initialise the manualmarking HTML.
 * @method initManualmarkingHtml
 * @static
 */
dwv.gui.base.initManualmarkingHtml = function()
{
    var colourSelector = document.getElementById("lwColourSelect");
    colourSelector.selectedIndex = 1;
    dwv.gui.refreshSelect("#lwColourSelect");
