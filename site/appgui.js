...
//Classifier
dwv.gui.appendClassifyboxHtml = function(){
	dwv.gui.base.appendClassifyboxHtml();
};
dwv.gui.displayClassifyHtml = function(bool){
    dwv.gui.base.displayClassifyHtml(bool);
};
...
dwv.gui.appendToolboxHtml = function(){
    ...
    var classify = document.createElement("a");
    classify.href = "#popupClassify";
    classify.setAttribute("class", buttonClass + " ui-icon-action");
    classify.setAttribute("data-rel", "popup");
    classify.setAttribute("data-position-to", "window");
